...
class TgenieBrowserLauncher:
    ...
    def open_login_browser(self, url: str, profile_dir: Path) -> TgenieLoginBrowserSession:
        ...
        try:
            ...
            return TgenieLoginBrowserSession(context=context, playwright_manager=manager)
